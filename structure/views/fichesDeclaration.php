...
<div class="container" id="hide">
    ...
    ?>
<a href="add-contribuable.php" class="btn btn-large btn-primary"><i class="glyphicon glyphicon-plus"></i> &nbsp; Editer une fiche de déclaration</a>
...
<div class="container card table-responsive">
    <h3 class="text-center text-primary">Déclarations Immeubles</h3>
    ...
    <tbody>
    <?php
        $query = "select * from fiche_paie";         
        $contribuable->fill_table($query);
     ?>
    </tbody>
