...
<div class="container card table-responsive">
    <h3 class="text-center text-primary">Paiements validés</h3>
    ...
    <tbody>
    <?php
        $query = "select note_perception.*, fiche_paie.nom, fiche_paie.prenom, fiche_paie.localisation_immeuble, fiche_paie.nb_locataires from note_perception, fiche_paie where note_perception.id_contribuable=fiche_paie.id and note_perception.status=1";         
